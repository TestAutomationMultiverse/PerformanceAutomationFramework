 ...
 * 
 * <p>This test creates a simple HTTP request and executes it using the TestEngine,
 * which now generates both JTL and HTML reports.</p>
 */
public class HtmlReportDemoTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        engine.setThreads(5)
              .setIterations(10)
              .setRampUp(Duration.ofSeconds(5))
              .setProtocolName("http_demo")
              .setTestPlanName("HTML Report Demo Test");
