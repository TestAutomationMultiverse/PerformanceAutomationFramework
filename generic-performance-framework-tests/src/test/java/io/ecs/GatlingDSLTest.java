...
/**
 * GatlingDSLTest - YAML Configuration Test Class
 * 
 * This class demonstrates how to use the YAML configuration-driven approach 
 * for defining and executing performance test scenarios with Gatling.
 * 
...
public class GatlingDSLTest {
    ...
    public static List<TestResult> runYamlConfigTest(String configFile) throws Exception {
        ...
        try {
            // Convert model.ExecutionConfig to engine.ExecutionConfig for Gatling
            ...
            engine = new GatlingEngine(engineConfig);
